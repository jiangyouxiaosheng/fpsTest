...
{
    public class FPSSprintMoveState : FPSMovementStateBase
    {
        public override FPSMoveState currentType => FPSMoveState.SprintMove;
        ...
        {
            currentPlanarSpeedLimit = planarMovementParameters.boostSpeedLimit;
